...
/**
 * Strings for component 'repository_datatelcmm'
 *
...
$string['pluginname'] = 'CMM - Copy File to Moodle';
...
$string['sslcawarning'] = 'Without a certificate issued by a CA, the communications between Moodle and the CMM site are ' .
        'less secure since Moodle will trust any certificate it receives.';
$string['certexplanation'] = 'If the SSL certificate used by the CMM site was issue by a CA, you may use this field to ' .
...
$string['domainexplanation'] = 'Enter a domain ONLY if you are using Active Directory for authentication in SharePoint. ' .
        'Enter the value users would enter when logging in. ' .
        'For example, if your usernames have a format of "COLLEGE\username", you would enter "COLLEGE" in this field.';
